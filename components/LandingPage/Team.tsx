            ...
            <div className="component-container-intro">
                <div className="nft-frame">
                    <Image
                        ...
                        height={135}
                    />
                    <p className="title-wild-frame-typo text-greeny">
                        Maxime
                    </p>
                    <p className="subtitle-typo text-white">
                        Fondateur
                    </p>
                </div>
                <div className="nft-frame">
            ...
            <div className="pl-2 pr-4 mb-40">
                <div className="text-white text-base mt-14 flex justify-center items-center">
                    <div className="text-white body-typo pl-4 w-600 text-justify">
                        Un grand merci à tout ceux qui ont posé une brique dans l’édifice Wildians :<br />
                        <strong>Romain, le PAE SIGL (Johnny et Sach), Eva, Rebecca, Gwen, Hugo x2, Alice</strong>
                    </div>
                </div>
            </div>
        </div>
