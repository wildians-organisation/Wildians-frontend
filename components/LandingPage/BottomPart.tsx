                ...
                >
                    <div className="text-white pl-6" style={{ width: "598px" }}>
                        ...
                        >
                            ...
                            <br />
                            la culture <br />
                            du <span style={{ color: "#90E0D3" }}>développement durable</span>
                            <br />
                            et de <span style={{ color: "#90E0D3" }}>passer à l’action</span>, <br />
                            ensemble.
                        </p>
                    </div>
                    <div className="text-white pl-6" style={{ width: "598px" }}>
                        ...
                        >
                            ...
                            <b>
                                <b>
                                    <br />
                                    Transformons nos <span style={{ color: "#90E0D3" }}>habitudes</span> pour un <span style={{ color: "#90E0D3" }}>monde
                                    plus durable</span>.
                                </b>
                            </b>
                            <img
            ...
            >
                ...
                <div className="text-white pl-6" style={{ width: "625px" }}>
                    ...
                    <p>
                        ...
                        participe à la construction de celle-ci en nous
                        partageant tes retours ici :{" "}
                    </p>
