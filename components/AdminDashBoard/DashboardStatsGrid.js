import { IoWalletOutline, IoPersonAdd, IoRecordingOutline, IoGlobeOutline, IoSwapHorizontalOutline,IoTrendingUpOutline} from 'react-icons/io5'
    ...
    return (
        <div className="grid lg:grid-cols-3 gap-5 mb-16">
            <BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Total wallet client</span>
			...
			<BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Last Transaction</span>
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">03/14/2023</strong>
					</div>
				</div>
			</BoxWrapper>
            <BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Last 2 weeks Connexion</span>
					<div className="flex items-center">
			...
			<BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Total Month Connexion</span>
					<div className="flex items-center">
            ...
            <BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Total Month Transaction</span>
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">16</strong>
						<span className="text-sm text-red-500 pl-2">-43</span>
					</div>
