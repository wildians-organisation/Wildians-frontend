        ...
        <div className="card nft-card-layout nft-card-style flex ">
            ...
            <div className="w-3/5 p-4 flex-1 items-center justify-items-center">
                <div className="flex text-white items-baseline">
                    <span className="title-typo nft-name-layout name-layout mt-4 ml-6">Ellie </span>
                    <span className="nft-id-font">#001</span>
                </div>
                <div className="body-italic-typo text-white nft-pillar-layout ml-6">The primary pillar</div>
                <div className="mt-4 bio-layout">
                    <div className="title-typo text-white nft-name-layout mt-6 ml-6">Bio</div>
                    <div className="flex justify-between ml-6">
                        <div className=" bio-desc-layout"> 
                            <span className="text-white">By adopting me, you supported WWF</span>
                        </div>
                        <div
                ...
                <div>
                    <div className="title-typo text-white nft-name-layout attribute-layout mt-6 ml-6">Attributes</div>
