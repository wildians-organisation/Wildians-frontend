    ...
    return (
        <>
            <Layout>
                ...
                <div>
                    <label htmlFor="plateformeContact">
                        Plateforme du contact:
                    </label>
                    <input
                        type="text"
                        id="plateformeContact"
                        name="plateformeContact"
                        ...
                        {whitelistedUsers.map((whitelist) => (
                            ...
                            >
                                <td className="py-2 px-4 whitespace-nowrap">
                                    {whitelist.formData.adresseWallet}
                                </td>
                                <td className="py-2 px-4 whitespace-nowrap">
                                    {whitelist.formData.plateformeContact}
                                </td>
                                <td className="py-2 px-4 whitespace-nowrap">
                                    {whitelist.formData.loginMail}
                                </td>
                                <td className="py-2 px-4 whitespace-nowrap">
                                    {whitelist.formData.commentaire}
                                </td>
                                <td className="py-2 px-4 whitespace-nowrap">
                                    <button
                                        className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
                                        onClick={() =>
                                            handleDeleteClick(whitelist.id)
                                        }
                                    >
                                        Delete
                                    </button>
